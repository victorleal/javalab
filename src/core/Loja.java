...
public synchronized void cancelarPedido(Integer numero) throws ParametroException {
if (pedidos.containsKey(numero)) {
...
/********** PRODUTOS **********/
public synchronized void cadastrarProduto(String categoria, String conteudodaCaixa,
...
public synchronized void removerProduto(Integer id) throws Exception {
...
public synchronized void alterarProduto(Produto prod, double valor)
throws ParametroException {
Produto p = null;
...
public synchronized void alterarProduto(Produto prod, int estoque)
throws ParametroException {
Produto p = null;
if (produtos.containsKey(prod.getId())) {
p = produtos.get(prod.getId());
...
/********** TRANSPORTADORA **********/
public synchronized void cadastrarTransportadora(String cnpj, String nomeFantasia,
...
public synchronized void removerTransportadora(String cnpj) throws Exception {
...
public synchronized void alterarTransportadora(Transportadora transp, int prazo)
throws ParametroException {
...
public synchronized void alterarTransportadora(Transportadora transp, double taxa)
throws ParametroException {
Transportadora t = null;
if (transportadoras.containsKey(transp.getCnpj())) {
t = transportadoras.get(transp.getCnpj());
